      ...
      <div className="flex justify-center items-center size-full"> 
        ...
        <div id="parent" className="border-2 border-blue-800 p-2 size-2/3 flex bg-zinc-900 rounded-3xl shadow-xl mt-10 flex-col md:gap-4 md:p-4">
          ...
          <div id='groupdiv' className="p-0.5 flex md:flex-row flex-col size-full gap-1 md:gap-4">
            ...
            <img src="./images/5.jpg" className="absolute inset-0 size-full rounded-3xl object-fill" alt="image" />
            </div>
            <div id="indiv-div" className="relative border border-red-600 size-full rounded-3xl flex-[1] hover:flex-[2] transition-all duration-1000 flex">
              <img src="./images/1.jpg" className="absolute inset-0 size-full rounded-3xl object-fill" alt="image" />
            </div>
          </div>
          {/* 3rd row*/}
          <div id='groupdiv' className="p-0.5 flex md:flex-row flex-col size-full gap-1 md:gap-4">
            ...
            <img src="./images/2.jpg" className="absolute inset-0 size-full rounded-3xl object-fill" alt="image" />
            </div>
            <div id="indiv-div" className="relative border border-red-600 size-full rounded-3xl flex-[1] hover:flex-[2] transition-all duration-1000">
            <img src="./images/3.jpg" className="absolute inset-0 size-full rounded-3xl object-fill" alt="image" />
            </div>
            <div id="indiv-div" className="relative border border-red-600 size-full rounded-3xl flex-[1] hover:flex-[2] transition-all duration-1000">
            <img src="./images/4.jpg" className="absolute inset-0 size-full rounded-3xl object-fill" alt="image" />
            </div>
          </div>
